...
public class ValidarxmlAPP {
					...
					//y lo recorremos con un bucle while usando el metodo .hasNext() para comprobar si tiene mas lineas
						while(sc.hasNext()){
							...
							//guardamos en una variable la linea y la mostramos
								if(linea.equals("﻿")){
									//Estra�amente al abrir el archivo siempre me ha salido ese conjunto de simbolo
								...
								switch(tipo){
									case 1:
										...
										abiertas.add(a�adirEtiquetaAbierta(linea,atributos));
										break;
									case 2:
										/*Etiqueta que cierra*/
										//en una etiqueta cerrada no necesitamos comprobar nada
										cerradas.add(a�adirEtiquetaCerrada(linea));
										break;
									case 3:
	...
	private static String a�adirEtiquetaCerrada(String linea) {
	...
	private static String a�adirEtiquetaAbierta(String linea, boolean atributos) {
		int e = linea.indexOf(" ");
